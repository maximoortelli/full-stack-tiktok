  ...
  return (
    <>
      <div
        ...
        className="
        fixed flex justify-center pt-14 
        md:pt-[105px] z-50 top-0 left-0 
        w-full h-full bg-black bg-opacity-50
        overflow-auto"
      >
        <div
          className={`
             relative bg-white w-full max-w-[700px]
             sm:h-[580px] h-[655px] mx-3 p-4 rounded-lg
             mb-10 ${!uploadedImage ? "h-[655px]" : "h-[580px]"}
         `}
        >
          <div
            className="
            ...
            {!uploadedImage ? (
              <div>
                    ...
                    <label htmlFor="image" className="relative cursor-pointer">
                      ...
                      <button
                        className="absolute bottom-0 right-0 rounded-full 
                                 bg-white shadow-xl border p-1 border-gray-300
                ...
                >
                  <h3
                    className="
                     font-semibold text-[15px] sm:mb-0 
                     mb-1 text-gray-700 sm:w-[160px]
                     sm:text-left text-center"
                  >
                    Name
                  </h3>

                   <div className="flex ites-center justify-center sm:-mt-6">
